...
def addfriend():
    ...
    friend_list["text"] = "Your bag: " + str(list1)
...
def random_number():
    ...
    lucky_friend["text"] = "your most important item: " + str(generated_random_number)
 btn = Button(root, text="Add to bag" , command = addfriend)
 btn.place(relx= 0.5,rely = 0.3, anchor=CENTER)
    
 friend_list.place(relx= 0.5,rely = 0.5, anchor = CENTER)
    
    btn1 = Button(root, text="what is your most important item" , command = random_number)
